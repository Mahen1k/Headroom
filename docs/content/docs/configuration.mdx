...
| `HEADROOM_MIN_INPUT_TOKENS` | Skip compression for inputs below this token count; set to `0` to disable the guard. | `100` |
| `HEADROOM_DIVERSITY_LAMBDA` | Relevance/diversity tradeoff for Kompress sentence selection, clamped to `0`–`1`. | `0.7` |
